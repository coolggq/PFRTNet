...
def main(args, work):
    ...
    # build dataset
    # dataset_val = build_dataset(args, mode='test2') # val
    dataset_val = _create_data_loader(args, mode='test1')  # ,dataset='IXI'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--experiment", default="sr_multi_ProFact", help="choose a experiment to do")# edsr
